...
const CompanyPrivateIncome = () => {
  ...
  const handleNextTab = () => {
    ...
    if (currentIndex < subTabs.length - 1) {
      ...
      router.push('/dashboard/company-private/deductions');
    }
  };
  ...
  return (
    <div className="w-full min-h-screen bg-[#F8F9FC]">
      ...
      <div className="w-full flex justify-center pt-8 pb-4">
        <Stepper1 currentStep={2} customSteps={mainSteps} />
      </div>
        ...
        <div className="max-w-[1000px] w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6 mt-4">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      <Button 
                      variant="brand"
                       className=" text-white border-none px-4 py-2 h-auto text-md font-medium rounded"> Add more items</Button>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center justify-between gap-2 mt-4">
                  ...
                  <Button  
                  variant="brand"
                   className=" text-white w-80 border-none px-6 py-2 h-auto text-md font-medium rounded">Add Income From Crypto/VDA</Button>
                </div>
              </FormSection>
              ...
              >
                <div className="flex items-center justify-between gap-2 mt-4">
                  <p className="font-poppins font-normal text-[16px] leading-5 text-[#8E8E93]">If you have any income from a Investment Fund or Business Trust, then report the same here.</p> 
                     <Button  
                  variant="brand"
                   className=" text-white w-100 border-none px-6 py-2 h-auto text-md font-medium rounded">Add Income From Business Trust/Fund</Button> 
              ...
              >
                <div className="flex items-center justify-between mt-4">
                  <p className="font-poppins font-normal text-[16px] leading-5 text-[#8E8E93]">Do you have any income from Interests from PPF or Other Income which are exempt?</p> 
                       <Button  
                  variant="brand"
                   className=" text-white border-none px-6 py-2 h-auto text-md font-medium rounded">Add Exempt Income</Button>
                </div>
              </FormSection>
              ...
              >
                <div className="flex items-center justify-between mt-4">
                  <p className="font-poppins font-normal text-[16px] leading-5 text-[#8E8E93]">Do you have any Income from Agriculture?</p> 
                         <Button  
                  variant="brand"
                   className=" text-white border-none px-6 py-2 h-auto text-md font-medium rounded">Add Agriculture Income</Button>
                </div>
              </FormSection>
              ...
              <div className="flex justify-start mt-2">
                <Button 
                 variant="brand"
                 className="text-white border-none px-8 py-2 h-auto text-[16px] font-medium rounded">Save</Button>
              </div>
            </div>
          )}
          ...
          {activeTab === 'house' && (
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-[#EAF5EA] text-[#4CAF50] font-poppins text-sm p-4 rounded flex items-center gap-2 border border-[#C8E6C9]">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button  
                   variant="brand"
                   onClick={() => router.push('/dashboard/company-private/deductions')} className="px-6 py-2  text-white rounded font-poppins font-medium text-sm">
                    Go To Next 
                  </Button>
                </div>
              </div>
...
export default CompanyPrivateIncome;
